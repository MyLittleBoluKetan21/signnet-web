<x-guest-layout>
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- ALERT STATUS --- */
        .status-alert { background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); color: #10b981; padding: 12px 16px; border-radius: 10px; font-size: 13px; margin-bottom: 20px; text-align: center; }
        ...
        .back-link { display: flex; align-items: center; justify-content: center; gap: 6px; margin-top: 20px; font-size: 12px; color: var(--text-muted); text-decoration: none; transition: all .2s ease; }
            ...
            <div class="card-animator">
                <div class="card">
                    <div class="brand">
                        ...
                        <div class="brand-sub">Reset Sandi Administrator</div>
                    </div>

                    <div class="info-text">
                        Lupa kata sandi? Masukkan alamat email Anda di bawah ini dan kami akan mengirimkan tautan pemulihan akun Anda.
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="admin@signnet.com" required autofocus />
                            </div>
                            @if($errors->has('email'))
