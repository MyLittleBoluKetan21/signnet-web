<x-guest-layout>
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- WRAPPERS & CARD --- */
        .login-page-wrapper { min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 110px 24px 50px; position: relative; z-index: 1; }
        ...
        .card { 
            background: var(--bg-card); border: 1px solid var(--border-login); border-radius: 18px; padding: 36px 32px 30px; width: 100%; position: relative;
        ...
        .error-alert { color: #ef4444; font-size: 12px; margin-top: 6px; display: block; font-weight: 500; }
        ...
        .input-wrap input { 
            width: 100%; background: var(--bg-input); border: 1px solid var(--border-login); border-radius: 10px;
            color: var(--text-primary); font-family: inherit; font-size: 13px; padding: 12px 16px 12px 42px; outline: none; transition: border-color 0.2s ease;
        }
        .input-wrap .has-toggle { padding-right: 42px; }
        .input-wrap input:focus { border-color: var(--border-focus); }
        
        .toggle-pw { position: absolute; right: 14px; background: none; border: none; cursor: pointer; color: var(--text-muted); display: flex; align-items: center; padding: 0; transition: all .2s ease; }
        ...
        .btn-submit { display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%; background: var(--accent);
            ...
            cursor: pointer; transition: all .25s ease; box-shadow: 0 4px 20px rgba(37,99,235,.28); margin-top: 8px; }
        .btn-submit svg { transition: transform .25s ease; }
        ...
        .switch-auth { display: block; text-align: center; margin-top: 18px; font-size: 12.5px; color: var(--text-muted); text-decoration: none; transition: color .2s ease; }
        .switch-auth:hover { color: var(--text-primary); text-decoration: underline; }
        ...
        @media (max-width: 480px) { .login-page-wrapper { padding: 90px 16px 30px; } .card { padding: 32px 20px 24px; } }
    </style>
            ...
            <div class="card-animator">
                <div class="card">
                    <div class="brand">
                        ...
                        <div class="brand-sub">Registrasi Akun Baru</div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Muhamad Aldi" required autofocus autocomplete="name" />
                            </div>
                            @if($errors->has('name'))
                                <span class="error-alert">{{ $errors->first('name') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="admin@signnet.com" required autocomplete="username" />
                            </div>
                            @if($errors->has('email'))
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input id="password" class="has-toggle" type="password" name="password" placeholder="•••••••••" required autocomplete="new-password" />
                                <button type="button" class="toggle-pw" onclick="togglePasswordVisibility('password', 'eye-1', 'eye-off-1')">
                                    <svg id="eye-1" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                        <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z"/>
                                        <circle cx="12" cy="12" r="3"/>
                                    </svg>
                                    <svg id="eye-off-1" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" style="display:none">
                            ...
                            @if($errors->has('password'))
                                <span class="error-alert">{{ $errors->first('password') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-wrap">
                                ...
                                <input id="password_confirmation" class="has-toggle" type="password" name="password_confirmation" placeholder="•••••••••" required autocomplete="new-password" />
                                <button type="button" class="toggle-pw" onclick="togglePasswordVisibility('password_confirmation', 'eye-2', 'eye-off-2')">
                                    <svg id="eye-2" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                        <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z"/>
                                        <circle cx="12" cy="12" r="3"/>
                                    </svg>
                                    <svg id="eye-off-2" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" style="display:none">
                                        <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20C5 20 1 12 1 12a21.68 21.68 0 0 1 5.06-5.94"/>
                                        <path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a21.68 21.68 0 0 1-2.16 3.19"/>
                                        <path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"/>
                                        <line x1="1" y1="1" x2="23" y2="23"/>
                            ...
                            @if($errors->has('password_confirmation'))
                                <span class="error-alert">{{ $errors->first('password_confirmation') }}</span>
                            @endif
                        </div>
                    ...
                    <a class="switch-auth" href="{{ route('login') }}">
                        Sudah terdaftar? Silakan masuk disini
                    </a>
                </div>
            </div>
