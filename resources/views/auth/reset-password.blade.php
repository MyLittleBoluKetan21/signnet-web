<x-guest-layout>
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-animator { width: 100%; max-width: 400px; animation: cardEntrance 0.7s cubic-bezier(0.16, 1, 0.3, 1) both; will-change: transform, opacity; }
        ...
        .input-wrap input { 
            ...
            color: var(--text-primary); font-family: inherit; font-size: 13px; padding: 12px 42px; outline: none; transition: border-color 0.2s ease;
        }
        ...
        @media (max-width: 768px) {
            ...
            /* BARIS YANG MEMBUAT LOGO HILANG SUDAH DIHAPUS DI SINI */
            ...
            <div class="card-animator">
                <div class="card">
                    <div class="brand">
                        ...
                        <div class="brand-sub">Perbarui Kata Sandi</div>
                    </div>
