                ...
                fire(type, title, message) {
                    ...
                    return Swal.fire({
                        ...
                        html: `
                            <div class="p-2">
                                ${config.iconHtml}
                                <p class="text-[10px] font-black tracking-[0.3em] text-slate-500 uppercase mb-2">System Status: ${config.label}</p>
                                <p class="text-sm text-slate-300 font-medium">${message}</p>
                            </div>
                        `,
                        ...
                        customClass: {
                            popup: `rounded-[2.5rem] border border-slate-800 shadow-2xl`,
                            title: `text-xl font-black tracking-tighter pt-8`,
                            confirmButton: `px-10 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest active:scale-95 transition-all mb-6`
                        },
                        didOpen: (el) => {
