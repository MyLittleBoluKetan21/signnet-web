...
<aside id="sidebar" class="fixed top-0 bottom-0 left-0 md:sticky md:top-0 h-dvh md:h-dvh bg-[#020617] dark:bg-[#020617] flex flex-col items-start justify-between py-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] border-r border-white/10 shadow-xl w-64 md:w-24 md:hover:w-64 transition-all duration-200 ease-in-out group/sidebar overflow-hidden z-[999] -translate-x-full md:translate-x-0">
    ...
    <nav class="sidebar-nav flex flex-col gap-1 w-full px-3 flex-1 min-h-0 overflow-y-auto overflow-x-hidden custom-scroll">
    ...
    <div class="flex flex-col gap-2 w-full px-3 shrink-0 pt-2 border-t border-white/5 mt-auto">
